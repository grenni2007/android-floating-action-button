...
public class FloatingActionButton extends ImageButton {
    ...
    void init(Context context, AttributeSet attributeSet) {
        ...
        mColorRipple = attr.getColor(R.styleable.FloatingActionButton_fab_colorRipple, getColor(R.color.ripple_material_dark));
    ...
    @SuppressLint("NewApi")
    private Drawable getFillDrawableWithRipple(float strokeWidth) {
        ColorStateList rippleColor = ColorStateList.valueOf(mColorRipple);
        Drawable normalDrawable = createCircleDrawable(mColorNormal, strokeWidth);
        return new RippleDrawable(rippleColor, normalDrawable, normalDrawable);
    }
